...
This field appears only when the relative duration is selected in the **Duration type** field. For more information, see [SLA duration types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-service-management/service-level-management/c_SLADuration.md).

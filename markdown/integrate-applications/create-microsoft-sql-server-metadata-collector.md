...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the Microsoft SQL Server collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/prepare-to-run-microsoft-sql-server-collector.md).

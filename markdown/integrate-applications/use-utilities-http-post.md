...
You can configure the properties for the Post component. For more information about these properties, see [Properties of the HTTP components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/properties-http-components.md).

...
You can use the [Is AD Account Locked activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_IsADAccountLocked.md) activity to determine if an account is locked.

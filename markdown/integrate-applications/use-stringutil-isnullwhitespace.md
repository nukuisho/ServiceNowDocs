...
You can configure the properties for the IsNullOrWhiteSpace component. For more information about these components, see [Properties of the String Utilities components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/util-stringutil-prop.md).

...
description: The HL7 FHIR Spoke provides eight read-only actions — a look-up-by-ID action and a stream action for each of the four FHIR R4 provider-directory resources. This reference lists the key inputs and outputs of each action.
locale: en-US
release: australia
...
The HL7 FHIR Spoke provides eight read-only  actions — a look-up-by-ID action and a stream action for each of the four FHIR R4 provider-directory resources. This reference lists the key inputs and outputs of each action.

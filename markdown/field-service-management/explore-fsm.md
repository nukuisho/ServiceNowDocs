...
|Enable agents to generate work order task summaries so that they can create notes faster and with more detail.|[AI capabilities in Field Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/field-service-management/exploring-now-assist-fsm.md)|Field Service Agent|
|On-board contractor teams for outsourcing work order tasks and ensuring that service level agreements are met.|[Field Service Contractor Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/field-service-management/fsm-contractor-management.md)|Manager|

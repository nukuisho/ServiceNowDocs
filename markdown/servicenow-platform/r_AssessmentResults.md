...
-   The user does not answer the question and the [data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/r_DataTypes.md) is not Checkbox.

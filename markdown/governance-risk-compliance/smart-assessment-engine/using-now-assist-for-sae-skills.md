...
## Now Assist for SAE skills overview

Now Assist for SAE uses generative AI to speed up routine SAE tasks. It provides prebuilt skills for tasks like drafting automatic responses for assessment. These skills are activated and configured via the Now Assist Admin console.
...
## Modify the instructions for Now Assist for SAE skills

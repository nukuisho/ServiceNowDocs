...
-   To update the number of the records for a reference field, see [Update number of records for reference fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/governance-risk-compliance/configure-referencefield-system-property.md).
-   To update the number of the element definitions for dependency assessment, see [Update the number of element definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/governance-risk-compliance/update-ele-def-for-dependency-assessment.md).

...
You can also use checklists with task records in the standard interface. For more information, see [Checklists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/c_Checklists.md).

---
title: Enable Spend categorization agent in Now Assist panel
description: Enable the Spend categorization agent in AI Agent Studio so users can run it from the Now Assist panel to validate and update product and spend categories on procurement records.
locale: en-US
...
keywords: [Spend categorization agent, Now Assist panel, AI Agent Studio, agent activation]
...
# Enable Spend categorization agent in Now Assist panel
...
3.  Verify that the agent is configured to run in the Now Assist panel.

    The agent is configured to run in the Now Assist panel and the virtual agent channel.

4.  Enable the agent.

    The Spend categorization agent is active and available in the Now Assist panel.

5.  Open a supported procurement record, then open the Now Assist panel to verify the agent is listed.
...
Users can run the Spend categorization agent from the Now Assist panel to predict, validate, and update product and spend categories.

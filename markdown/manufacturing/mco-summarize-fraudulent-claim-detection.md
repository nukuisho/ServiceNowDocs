...
The App Anomaly Detection Rule \[com.sn\_anomaly\_detect\] framework is used to identify the fraudulent claims. The Agents portal displays the fraudulent repair claims submitted from the dealer portal using the \[com.sn\_anomaly\_detect\] based rules:
